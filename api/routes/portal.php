    ...
    function portalUpdateUser($id)
    {
        $body = jsonBody();
        $db = getDB();
        $allowed = ['first_name', 'middle_name', 'last_name', 'username', 'phone', 'alt_phone', 'password', 'date_of_birth', 'role', 'unit_id', 'region_id', 'circle_id', 'campus_id', 'avatar_url', 'status', 'permission_overrides'];
        $sets = [];
        $params = [];
