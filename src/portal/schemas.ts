...
export const PerfFormSchema = z.object({
  ...
  scope_unit_ids: z.union([z.array(z.string()), z.string()]).nullable().optional(),
  scope_region_id: z.string().nullable().optional(),
  scope_region_ids: z.union([z.array(z.string()), z.string()]).nullable().optional(),
  ...
  title_color: z.string().nullable().optional(),
  title_font_size: z.number().nullable().optional(),
  title_font_weight: z.string().nullable().optional(),
  description_color: z.string().nullable().optional(),
  description_font_size: z.number().nullable().optional(),
  description_font_weight: z.string().nullable().optional(),
